...
export default function AdminUsers() {
  ...
  const users = [
    { id: 1, name: 'Jean Dupont', email: 'etudiant@example.com', role: 'Étudiant', status: 'Actif', lastLogin: '2024-03-20' },
    { id: 2, name: 'Marie Martin', email: 'marie@example.com', role: 'Étudiant', status: 'Actif', lastLogin: '2024-03-19' },
    { id: 3, name: 'Pierre Durand', email: 'pierre@example.com', role: 'Professeur', status: 'Actif', lastLogin: '2024-03-18' },
    { id: 4, name: 'Sophie Lambert', email: 'sophie@example.com', role: 'Étudiant', status: 'Inactif', lastLogin: '2024-03-01' },
  ];
